...
class VendingMachine {
    ...
    func vend(itemNamed name: String) throws {
        ...
        guard item.price <= coinsDeposited else { //guard不满足条件,语句立即用return或者throw结束
...
func buyFavoriteSnack(person: String, vendingMachine: VendingMachine) throws {
    ...
    try vendingMachine.vend(itemNamed: snackName) // 抛异常,buyFavoriteSnack接着抛
}
...
let s = try? PurchasedSnack(name: "", vendingMachine: v)
